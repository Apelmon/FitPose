...
public class WinPopupView : PopupConfig {
    ...
    public override void OnViewEnable(UiEntity entity) {
        ...
        Prefs.SetIntPrefs(Prefs.SCORE, gsContext.score.value);
...
//            gsContext.currentLevel.value.ToString("00000"), gsContext.score.value);
        ...
        if (_level == null) throw new NullReferenceException("Level text is missing!");
        _level.text = "Level " + gsContext.currentLevel.value.ToString();
